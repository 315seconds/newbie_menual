...
- 🗓 월초 자동 롤오버 (ex. 3월 1일엔 2월 마지막날 매출을 2월 폴더내에 있는 2월 공판 엑셀파일에 작업을 하고 그 후에 2026 폴더안에 3월 폴더를 만들고 2월의 '전매장매출' 시트의 수식유지하고 내용만 리셋해서 '2026.03.공동판매' 파일로 생성 그럼 그 파일의 입고시트를 가지고 우리가 항상 하던 '입고'시트 이월작업진행)
