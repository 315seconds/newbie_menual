...
- 📣 Slack Block Kit 리포트 자동 발송 (00:10분에 발송됨)
- 🗓 월초 자동 롤오버 (ex. 3월 1일에는 2월 마지막 날 매출을 2월 폴더 내에 있는 2월 공판 엑셀 파일에 반영한 후, 2026 폴더 안에 3월 폴더를 생성합니다. 이후 2월의 ‘전매장매출’ 시트에서 수식은 유지하고 내용만 리셋하여 ‘2026.03.공동판매’ 파일로 생성합니다. 그런 다음 해당 파일의 입고 시트를 기준으로 기존에 진행하던 ‘입고’ 시트 이월 작업을 진행하면 됩니다.)
